...
class ConfigurationTests: XCTestCase {
    let configuration = Configuration(timescale: Timescale(name: "test", maximum: 0, minimum: 10000, formatString: ""), reverseTime: false, notify: false, birthday: Date(timeInterval: 10000, since: .distantPast), deathday: Date(timeInterval: 20000, since: .distantPast))
